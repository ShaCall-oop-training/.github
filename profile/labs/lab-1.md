...
Поезда должны уметь рассчитывать пройденое расстояние, эти вычисления должны производиться автоматически, проезжая по рельсе. Скорость и ускорение поезда изначально имеют нулевые значения.
